<div wire:key="{{$specialist->id}}" class="flex flex-row flex-wrap gap-6 p-6" x-data="{unlockClicked: false, deleteClicked: false, id: '{{$specialist->id}}', name: '{{$specialist->name}}', email: '{{$specialist->email}}'}">
    @php
    ...
    <div class="flex flex-col w-full">
        <div class="flex flex-row items-center w-full" >
            ...
            <x-label for="name" value="{{ __('Specialist') }}" class="mb-2" />
            ...
            <div class="flex flex-col">
                <div class="flex justify-center">
                    <img height="32px" width="32px" class="mt-6 mb-2 ml-2"  :src="!unlockClicked ? '{{ url($locked) }}' : '{{ url($unlocked) }}'" >
                </div>
