...
class MaintenanceList extends Component
{
    ...
    public function placeholder(){
        return <<<'HTML'
            <div style="min-height:50vh" class="pl-4 mt-1 mb-2 rounded-md text-gray-600 border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 dark:focus:border-indigo-600 focus:ring-indigo-500 dark:focus:ring-indigo-600 shadow-sm flex justify-center items-center">
